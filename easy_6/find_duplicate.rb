...
# Understanding:
# Calculate occurrences of value
# Great system for tracking occurrences are hashes or associative arrays
# Make each value a key and track it's occurrence as hash value
...
def find_dup(array)
  ...
  duplicate = 0
  frequency_hash.each {|k, v| duplicate = k if v == 2}
  duplicate
end
